...
public class Table implements Serializable{
    ...
    public void verifyIncompatibilities(Table table) throws Exception{
        ...
        // for(int i = 0; i < numColFirst; i++){
        //     int trigger = 0;
        //     Class tempTable = table.getAllData().get(0).get(i).getClass();
        //     Class tempThis = this.getAllData().get(0).get(i).getClass();
        //     if( tempTable != tempThis) {
        //         //throw new Exception("Table incompatible to be unified: Some columns do not have same type");        // If some attribut doesn t have same types
        //     }
        // }
    }
